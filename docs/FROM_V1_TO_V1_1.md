...
MammoDiffusion v1.1 is the direct methodological evolution of the original V1
...
## 3. Why the current pipeline was developed
...
MammoDiffusion v1.1 froze a 24-run classifier matrix, retained keyed predictions, separated generator
...
| Area | V1 prototype | MammoDiffusion v1.1 |
|---|---|---|
